    ...
    window:
        ...
        if who is not None:
            ...
            window:
                id "namebox"
                style "namebox"
                text who id "who" size 50 offset(55,-5)
                # color "#0000ff" outlines [(absolute(1), "#fff", absolute(0), absolute(0))]

        # text what id "what"
        if renpy.is_seen(ever=True):
            text what id "what" color "#fff000" outlines [(absolute(1), "#000", absolute(0), absolute(0))] size 30 offset(0,-30)
        else:
            text what id "what" color "#fff" outlines [(absolute(1), "#000", absolute(0), absolute(0))] size 30 offset(0,-30)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("回退") action Rollback() text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("历史") action ShowMenu('history') text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("快进") action Skip() alternate Skip(fast=True, confirm=True) text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("自动") action Preference("auto-forward", "toggle") text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("保存") action ShowMenu('save') text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("快存") action QuickSave() text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            # textbutton _("快读") action QuickLoad() text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("设置") action ShowMenu('preferences') text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("CG画廊") action ShowMenu('gallery')
...
screen main_menu():
    ...
    hbox:
        ...
        offset(120,560)
        spacing 1
        # imagebutton idle "gui/button/tianxi.png" offset(350,20) at menu_button_see(): #永恒天希菜单按钮
        #     activate_sound "sound/button_1.ogg"
        #     action [Hide("main_menu"),ShowMenu("tianxi_menu")]
        add "gui/button/tianxi.png" offset(350,20) alpha 0.5 #TODO 天希主线待做

        # imagebutton idle "gui/button/mengli.png" offset(525,20) at menu_button_see(): #梦璃幻世菜单按钮
        #     activate_sound "sound/button_1.ogg"
        #     action [Hide("main_menu"),ShowMenu("mengl_menu")]
        add "gui/button/mengli.png" offset(525,20) alpha 0.5 #TODO 梦璃待做

        imagebutton idle "gui/button/tedian.png" offset(700,-5) at menu_button_see(): #特典菜单按钮
            activate_sound "sound/button_1.ogg"
            action [Hide("main_menu"),ShowMenu("tedian_menu")]

    hbox:
        xcenter 0
        ycenter 0
        offset(120,640)
        imagebutton idle "gui/button/settings.png" offset(432,10) at menu_button_see():
            activate_sound "sound/button_1.ogg"
            action ShowMenu("preferences")
        imagebutton idle "gui/button/dev_info.png" offset(645,10) at menu_button_see():
            activate_sound "sound/button_1.ogg"
            action ShowMenu("about")
        # ycenter
        # text "Hello" size 50 color "#00ff00"
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("快进") action Skip() alternate Skip(fast=True, confirm=True) text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("自动") action Preference("auto-forward", "toggle") text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
            textbutton _("菜单") action ShowMenu() text_color "#fff" text_font "Gunshihei.ttf" text_size 25 text_outlines [(absolute(1), "#000", absolute(0), absolute(0))]
